...
public class HANNS_XOR_FitnessFunction_2 extends HyperNEATFitnessFunction{
...
//		EvaluatorHANNS evaluator = (EvaluatorHANNS)this.evaluators[threadIndex];
		...
		for (int i = 0; i < number_of_steps; i++) {
			...
			int nand1_1 = (int)Math.round(in1*gridNet.getWeights()[0][0][0][0][1][0]+in2*gridNet.getWeights()[0][GRID_RANGE][1][0][1][0]);
			int nand1_2 = (int)Math.round(in1*gridNet.getWeights()[0][0][0][0][1][1]+in2*gridNet.getWeights()[0][GRID_RANGE][1][0][1][1]);
			int nand1_out = nand(nand1_1,nand1_2);
			...
			int nand2_1 = (int)Math.round(in1*gridNet.getWeights()[0][0][0][0][3][0]+in2*gridNet.getWeights()[0][GRID_RANGE][1][0][3][0]);
			int nand2_2 = (int)Math.round(in1*gridNet.getWeights()[0][0][0][0][3][1]+in2*gridNet.getWeights()[0][GRID_RANGE][1][0][3][1]);
			int nand2_out = nand(nand2_1,nand2_2);
			
			int and2_1 = (int)Math.round(in1*gridNet.getWeights()[0][0][0][0][4][0]+in2*gridNet.getWeights()[0][GRID_RANGE][1][0][4][0]);
			int and2_2 = (int)Math.round(in1*gridNet.getWeights()[0][0][0][0][4][1]+in2*gridNet.getWeights()[0][GRID_RANGE][1][0][4][1]);
			int and_2_out = and(and1_1,and1_2);
			
			int or2_1 = (int)Math.round(in1*gridNet.getWeights()[0][0][0][0][5][0]+in2*gridNet.getWeights()[0][GRID_RANGE][1][0][5][0]);
			int or2_2 = (int)Math.round(in1*gridNet.getWeights()[0][0][0][0][5][1]+in2*gridNet.getWeights()[0][GRID_RANGE][1][0][5][1]);
			int or2_out = or(or2_1,or2_2);
			//1st->2nd layer
			int and3_1 =(int)Math.round(or1_out*gridNet.getWeights()[1][0][0][0][0][0]+nand1_out*gridNet.getWeights()[1][1][0][0][0][0]+
					and_1_out*gridNet.getWeights()[1][2][0][0][0][0]+nand2_out*gridNet.getWeights()[1][3][0][0][0][0]+
					and_2_out*gridNet.getWeights()[1][4][0][0][0][0]+or2_out*gridNet.getWeights()[1][5][0][0][0][0]);
			
			int and3_2 =(int)Math.round(or1_out*gridNet.getWeights()[1][0][0][0][0][1]+nand1_out*gridNet.getWeights()[1][1][0][0][0][1]+
					and_1_out*gridNet.getWeights()[1][2][0][0][0][1]+nand2_out*gridNet.getWeights()[1][3][0][0][0][1]+
					and_2_out*gridNet.getWeights()[1][4][0][0][0][1]+or2_out*gridNet.getWeights()[1][5][0][0][0][1]);
			int and3_out = and(and3_1,and3_2);
			
			int nand3_1 =(int)Math.round(or1_out*gridNet.getWeights()[1][0][0][0][0][0]+nand1_out*gridNet.getWeights()[1][1][0][0][0][0]+
					and_1_out*gridNet.getWeights()[1][2][0][0][0][0]+nand2_out*gridNet.getWeights()[1][3][0][0][0][0]+
					and_2_out*gridNet.getWeights()[1][4][0][0][0][0]+or2_out*gridNet.getWeights()[1][5][0][0][0][0]);
			
			int nand3_2 =(int)Math.round(or1_out*gridNet.getWeights()[1][0][0][0][1][1]+nand1_out*gridNet.getWeights()[1][1][0][0][1][1]+
					and_1_out*gridNet.getWeights()[1][2][0][0][1][1]+nand2_out*gridNet.getWeights()[1][3][0][0][1][1]+
					and_2_out*gridNet.getWeights()[1][4][0][0][1][1]+or2_out*gridNet.getWeights()[1][5][0][0][1][1]);
			int nand3_out = nand(nand3_1,nand3_2);
			
			int or3_1 =(int)Math.round(or1_out*gridNet.getWeights()[1][0][0][0][0][0]+nand1_out*gridNet.getWeights()[1][1][0][0][0][0]+
					and_1_out*gridNet.getWeights()[1][2][0][0][0][0]+nand2_out*gridNet.getWeights()[1][3][0][0][0][0]+
					and_2_out*gridNet.getWeights()[1][4][0][0][0][0]+or2_out*gridNet.getWeights()[1][5][0][0][0][0]);
			
			int or3_2 =(int)Math.round(or1_out*gridNet.getWeights()[1][0][0][0][2][1]+nand1_out*gridNet.getWeights()[1][1][0][0][2][1]+
					and_1_out*gridNet.getWeights()[1][2][0][0][2][1]+nand2_out*gridNet.getWeights()[1][3][0][0][2][1]+
					and_2_out*gridNet.getWeights()[1][4][0][0][2][1]+or2_out*gridNet.getWeights()[1][5][0][0][2][1]);
			int or3_out = nand(or3_1,or3_2);
			//2ndlayer->3rd layer
			int out =(int)Math.round(and3_out*gridNet.getWeights()[2][0][0][0][0][0]+nand3_out*gridNet.getWeights()[2][1][0][0][1][0]+
					or3_out*gridNet.getWeights()[2][2][0][0][2][0]);
